...
-   **Discuss whether [*additional*]{.underline} products or resources should be developed to improve communication and usefulness of the data and products for the community.** It will be important to be clear about your capacity and limitations going into this conversation so you can manage expectations and only commit to actions you can realistically take. Depending on what products you do decide to develop, it might be helpful to co-create them with your community partners so that messaging and functionality is as useful and impactful as possible. Some products that might be considered for development include:
