...
-   **Discuss whether additional products or resources might be helpful to improve communication and usefulness of the data and products for the community.** It will be important to be clear about your capacity and limitations going into this conversation so you can manage expectations and only commit to actions you can realistically take. Some products that might be considered for development include:

    -   A project fact sheet (aka one pager) that describes the project, available resources, and what it means for the community
