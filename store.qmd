...
## Project Preservation & Storage Framework
...
-   **What project components will be preserved and stored?** It might not be appropriate or helpful to save everything - think through ALL of the interim and final products you developed during each phase of the data life cycle and determine which items/products should be preserved and stored, and which should be deleted.
    ...
    -   The [Water Board DIT Web Document Remediation Guidance](https://waternet.waterboards.ca.gov/dit/websupport/accessibility/docs/guides/remediation_guidance_spreadsheet_v1_3.pdf) (requires VPN) may also be a useful reference for this step.
...
-   **How will products and files be named?** How we name things can make or break our ability to find and reuse things in the future. [Jenny Bryan has developed guidance on naming things](https://speakerdeck.com/jennybc/how-to-name-files), including:
    ...
    -   Make sure the name "plays well" with default ordering (e.g. add a date at the beginning of the file name)
        ...
        [![Graphic with a Public Service Announcement regarding how we write dates as numbers. Graphic from Bryan (2015) Naming Things slides](images/dates-psa_jenny-bryan.png){width="734"}](https://speakerdeck.com/jennybc/how-to-name-files?slide=21)

    -   For more guidance and resources on naming things, visit [Jenny Bryan's How to Name Files GitHub Repository](https://github.com/jennybc/how-to-name-files?tab=readme-ov-file#how-to-name-files)
