...
The [Planning phase](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/plan.html) of conducting an Equity Assessment is about clarifying your project scope, needs, and goals with an equity lens. Documenting how you will use data to achieve those goals during the remaining phases of the data life cycle, and making that documentation as open and transparent as possible, is best accomplished through the use of a Data Management Plan.

**Data Management Plan**

A Data Management Plan describes what data will be used, how the data will be [collected](https://cawaterboarddatacenter.github.io/equity-data-handbook/collect-process/collection.html), [processed](https://cawaterboarddatacenter.github.io/equity-data-handbook/collect-process/process.html), and managed to conduct your [analysis](https://cawaterboarddatacenter.github.io/equity-data-handbook/assure-analyze/analysis.html), [visualization](https://cawaterboarddatacenter.github.io/equity-data-handbook/viz-comm/vis.html) or other [communication](https://cawaterboarddatacenter.github.io/equity-data-handbook/viz-comm/communicate.html) products, and how those data products will be [stored](https://cawaterboarddatacenter.github.io/equity-data-handbook/store.html), [shared](https://cawaterboarddatacenter.github.io/equity-data-handbook/share.html), and maintained over the long-term.
...
1.  [Project Introduction & Context](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#project-introduction-context)
2.  [Data Collection & Processing](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#data-collection-processing)
3.  [Data Analysis & Product Development](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#data-analysis-product-development)
4.  [Data & Product Preservation & Storage](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#data-product-preservation-storage)
5.  [Data & Product Publication & Sharing](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#data-product-publication-sharing)
6.  [Data & Product Documentation](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#data-product-documentation)
7.  [Data & Product Evaluation](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html#data-product-evaluation)
...
Since the development the Data Management Plan ideally takes place before data are actually collected, some details, like specific analytical methods, may not be completely worked out. However, the Data Management Plan should include a clear vision and general plan for each section and include as much detail as possible.

## Project Introduction & Context

Here you want to briefly describe the project and the mechanism(s) driving the data collection and product development. Much of this will likely be worked out during the [Planning phase](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/plan.html), including:

-   What is the purpose of the selected program, policy, or process, related to this project?
-   What are the objectives of the project? \[Are there specific management questions being tested with data? Place them here! Include data quality objectives of you have them!\]
-   Who is the intended audience of the project?
-   How do you envision the project's resulting data and products contribute to the advancement and operationalization of equity for your program, policy, or process, related to this project?

## Data Collection & Processing

In this section, you will identify the data you plan on collecting, how you will collect it, and how you organize, manage, and process said data once it is collected. More detailed guidance on collection and processing of data and resultant products is outlined on the [Data Collection](https://cawaterboarddatacenter.github.io/equity-data-handbook/collect-process/collection.html) (including information on [Surveys](https://cawaterboarddatacenter.github.io/equity-data-handbook/collect-process/collection.html#surveys)), and [Data Processing](https://cawaterboarddatacenter.github.io/equity-data-handbook/collect-process/process.html) pages.

::: callout-important
# Be sure to pause and think about what you *actually* need to answer the questions/objectives you have using an equity lens.

As a reminder - **achieving racial equity outcomes means that race can no longer be used to predict life outcomes and outcomes for all groups are improved** ([Glossary](https://cawaterboarddatacenter.github.io/equity-data-handbook/appx.html#glossary))

So, as you create the list of data you want to collect for your project, it should contain:

1.  Data that can represent your management question(s) or project objectives. See the [Planning page](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/plan.html) for more guidance.
...
The Water Boards have a [quality management system](https://www.waterboards.ca.gov/water_issues/programs/quality_assurance/) and overarching Quality Assurance Management Plan. It may be helpful to review this material to consider how your project falls in that framework, and if more is needed to ensure all aspects of your project are of sufficient quality. For example, many programs do NOT have Quality Assurance Program Plans, so maybe your program (beyond just the data work) needs one. Reach out to the Data Quality Team if you need help.
...
-   What workflow will you use to analyze the data and/or develop the resultant data product?
-   What data analysis or visualization methods or software will you use?
-   What product(s) will be developed (e.g. analyses, visualizations, applications, reports, etc.) for each audience.
-   What statutory requirements, if any, need to be addressed in the resulting data products? 
...
-   If you collected data directly from Tribes or communities -
    ...
    -   How is informed consent being handled and how are privacy and sovereignty being protected?
...
-   [National Institutes of Health Data Management Resources](https://sharing.nih.gov/data-management-and-sharing-policy/data-management)
-   FAIR and CARE Principles Resources
    ...
    -   [Enabling FAIR data in Earth and environmental science with community-centric (meta)data reporting formats](https://www.nature.com/articles/s41597-022-01606-w)

    -   [Earth Science Data Repositories: Implementing the CARE Principles](https://doi.org/10.5334/dsj-2024-037.) (O’Brien et al., 2024)
