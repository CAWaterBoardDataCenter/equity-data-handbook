...
![Graphic illustrating three key components of the user-centered design process: Research, Empathy, and Iteration. Image from Justinmind (2020)](images/user-centered-design.png)
...
-   Water Boards Staff may also [request plain language review from the Office of Public Engagement, Equity, and Tribal Affairs](https://cawaterboards.sharepoint.com/sites/OPEETA-Resources/SitePages/Language-Services.aspx), although that service is more geared towards the review of fact sheets, brochures, and FAQs rather than data visualizations or other data products at this time.
-   Healthy Watershed Partnership [Guidance on Communicating Results](https://mywaterquality.ca.gov/healthy-watersheds/communicate-results.html)
