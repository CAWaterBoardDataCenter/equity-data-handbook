...
So, when we are deciding what to document, and begin the documentation process we should expect to document (almost) everything in some form, and plan to invest time accordingly. A list of things you may want to consider documenting is provided in the graphic below.
