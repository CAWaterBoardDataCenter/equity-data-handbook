...
-   **Are the data shown in the table essential to the story?** If you've followed the guidance in the [Data Processing step](https://cawaterboarddatacenter.github.io/equity-data-handbook/collect-process/process.html), then the data you use to create the visualization or data product should be tidy (yay!). Depending on the story you're trying to tell and the audience you're trying to connect with, including ALL of columns and rows of the processed data within visualization can feel overwhelming. Consider only displaying the essential rows and columns within the visualization and making the complete dataset available via download.
