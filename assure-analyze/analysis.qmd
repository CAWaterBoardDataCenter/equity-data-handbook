...
As with any analysis, we need to understand the limits of our data and the methods we use so we interpret the results we find appropriately. Beware of common data fallacies as you're interpreting your results and making conclusions:
