...
It's important to note, for the Water Boards context, that the information and knowledge we gain from our work may be used in complex situations. The better we understand how decisions are made (e.g., what goals, constraints, and incentives are relevant), and how they may impact different groups/communities, the more “wise” our data work can make decision-makers. As you conduct your analysis, it could be helpful to:

-   Refer back to your [Equity Assessment](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/plan.html) and [Data Management Plan](https://cawaterboarddatacenter.github.io/equity-data-handbook/plan-prep/prep.html) for a refresher on the original goals and objectives of your project/analysis.

-   Ask people with training in statistics to advise you - these could be internal colleagues or external partners.

-   Copy or build on the statistical approaches used in published, peer-reviewed work on similar or analogous situations.

-   Discuss your work with interested parties, and external partners.

-   Consider analyzing data in multiple ways to view it from different angles.
