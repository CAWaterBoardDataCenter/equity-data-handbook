...
::: callout-note
# The whole point of data analysis is to turn data into useful information, knowledge, and wisdom that we can use to make decisions and take action. 

Ideally, the data-informed decisions we make and the corresponding actions we take will help us advance and operationalize equity. Using data to inform decisions can be challenging, and is even more so when applying the equity lens to our data work.
:::
...
-   Flood M. D., Lemieux V. L., Varga M., and Wong B. L. W. (2016) '[The application of visual analytics to financial stability monitoring](https://doi.org/10.1016/j.jfs.2016.01.006)', Journal of Financial Stability, 27
