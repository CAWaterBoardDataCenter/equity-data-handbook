...
3.  Schedule time over the course of a few weeks to a few months to complete the process

4.  Interrogate the problem and associated data with an equity lens by asking "why" at least 5 times.

5.  Prioritize actions you/your team can take to address the root cause(s) of the problem.
...
![Graphical templates illustrating approaches to the problem interrogation process: A.](images/Eval_RCA_Templates.png)
