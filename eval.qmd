...
Below is a graphical templates teams can use to walk through Part 2 of the RBA process.

![Graphical template illustrating components of Part 2 of the RBA Process teams will go through to develop performance measures for each priority action that will enable collective accountability throughout the implementation process.](images/Eval_RCA_Performance.png)
