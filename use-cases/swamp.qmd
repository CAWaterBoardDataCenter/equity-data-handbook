...
The FHAB Partner Monitoring Program involves our SWAMP FHAB Program training and coordinating monitoring with our partners during the HAB season. The FHAB Program can provide sampling supplies and fund lab analysis to inform public health advisories. Partners can include non-profit organizations, California Tribes, counties, cities, bi-state collaborations, and others.
...
For more information see the [FHAB Pre-Holiday Assessment Webpage](https://sites.google.com/view/fhab-program-wiki/pre-holiday-assessment?authuser=0) and the [My Quality Portal](https://mywaterquality.ca.gov/habs/resources/habs_response.html)
