...
In addition to the terms defined in the [Handbook Glossary](https://cawaterboarddatacenter.github.io/equity-data-handbook/get-started/common-language.html#glossary), users should know the following terms when using demographic data:
