...
This includes investing the time required to follow the guidance on open data publishing at the Water Boards is available in the [Open Data Handbook](https://www.waterboards.ca.gov/resources/oima/cowi/open_data_handbook.html), including:
...
-   generate and ensure all metadata and documentation related to the data set is comprehensive and complete
