...
1.  Focus on the problem you are trying to solve. For example, what does the Water Board need to know to make an informed decision?

2.  Make your Water Boards data open and accessible to the public! See the [Open Data Handbook](https://www.waterboards.ca.gov/resources/oima/cowi/open_data_handbook.html) for guidance. This publishing step should be complete PRIOR to you exposing your data and information product(s) to the public.

3.  Determine what type of data project you are doing? Typical project types include “equity maps,” “demographics and program synthesis” and related dashboards.

4.  Collect and refine your management questions that are driving the data project.

5.  Research for examples of similar data projects, code, maps, project descriptions to help inform your work.
...
1.  Review this handbook and see if the guidance or references contained in any of the elements is helpful and complete the [Racial Equity Data Project Form](https://forms.office.com/g/0HuJqQkiJs). 
